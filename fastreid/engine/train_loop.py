...
class SimpleTrainer(TrainerBase):
    ...
    """
    def __init__(self, model, data_loader, optimizer, cfg, param_wrapper):
        """
        Args:
    ...
    def run_step(self):
        ...
        loss_dict, features, labels   = self.model(data)
        ...
        """
        self.optimizer.step()
        if "OIMLoss" in self.cfg.MODEL.LOSSES.NAME:
            self.model.oim_loss.update_features(features.detach(), labels)
...
class AMPTrainer(SimpleTrainer):
    ...
    def __init__(self, model, data_loader, optimizer,cfg,  param_wrapper, grad_scaler=None):
        """
        ...
        super().__init__(model, data_loader, optimizer, cfg, param_wrapper)
